...
export async function createUser(req, res) {
    try {
        ...
        const { firstName, lastName, registrationNumber, manipalEmailID, mobileNumber, isHosteller } = req.body;

        if (!firstName || !lastName || !registrationNumber || !manipalEmailID || !mobileNumber || !isHosteller) {
